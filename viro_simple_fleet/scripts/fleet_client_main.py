...
class FleetClient(Node):
    ...
    def simple_fleet_int_pub(self, notification):
        ...
        # special cases:
            ...
            # publish [green, nextnext_stop_id]: we wanna skip our current target for next.
            # publish [green, alternate_route]: we want to move to a shifted midpoint or alternate goal.
